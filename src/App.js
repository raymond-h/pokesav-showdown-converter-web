...
export default class App extends Component {
  ...
  render () {
    ...
    return <div className='vh-100 w-100 flex items-center justify-center bg-dark-gray bg-app' onDrop={this.handleFileDrop.bind(this)} onDragOver={this.handleDragOver.bind(this)}>
      <div className='pt4 ph5 pb5 br2 bg-dark-blue bg-panel-color shadow-1'>
        <div className='mw9 center sans-serif white'>
          <h1 className='font-title tc w-100 fade-in'>
            Pokemon savefile to Showdown converter
          </h1>
          <hr className='b--white-50 w-60 mv4' />
          <div className='font-body mw8 pt3 w-100 center flex flex-row'>
            ...
            <div className='fl w-60 pa2'>
              <div className='w-100 pa2 bg-white-10 shadow-1 br2 flex flex-column items-end'>
                <textarea className='db w-100 h5 ba b--none br2 pa2 ma0 mb2 bg-white-10 white consolas non-resizable' value={output} readOnly placeholder='Output goes here' />
